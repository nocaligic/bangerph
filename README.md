...
BANGR is a **decentralized prediction market** for Twitter/X engagement metrics. Users can:
...
└─────────────────────────────────────────────────────────────────┘
        ...
        ▼                     ▼                     ▼
┌───────────────┐   ┌─────────────────┐   ┌─────────────────┐
│  BSC Testnet  │   │  Twitter Proxy  │   │  Bangr Indexer  │
...
cd workers/bangr-indexer && npx wrangler dev --port 8788
```
