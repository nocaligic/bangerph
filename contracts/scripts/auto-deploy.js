...
async function deployContracts(deployer) {
    console.log("\n" + "=".repeat(50));
    console.log("🚀 DEPLOYING BANGR SIMPLIFIED CONTRACTS");
    ...
    const shareToken = await ShareToken.deploy("https://bangr.io/api/metadata/{id}");
...
async function main() {
    console.log("\n" + "=".repeat(50));
    console.log("💥 BANGR CONTRACT DEPLOYMENT");
    console.log("=".repeat(50));
    console.log("\nNetwork:", hre.network.name);
